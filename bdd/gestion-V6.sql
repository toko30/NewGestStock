...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 14 Janvier 2016 à 07:34
...
(2, 'Test 2', '', '0608', 11000, 10, 1, 2),
(3, 'Test 3', '', '1012', 32000, 5000, 2, 3),
(4, 'Test 4', '', '0406', 200, 100, 1, 1),
(5, 'Test 5', '', '0608', 2500, 2000, 1, 1);
...
INSERT INTO `composant_nomenclature` (`id`, `id_composant`, `id_nomenclature`, `quantite`, `position`, `option_st`) VALUES
(1, 1, 4, 5, 'U1,U2', 0),
(2, 3, 4, 10, 'D1,D2', 0),
(3, 5, 4, 2, 'A1,A2', 1),
(4, 2, 3, 3, 'A1,A2', 0),
...
(6, '45345', 3, '0000-00-00', '2015-12-02'),
(7, '453453', 3, '0000-00-00', '2015-12-09'),
(8, '5365643', 3, '0000-00-00', '2015-12-17'),
(9, '45634563', 4, '0000-00-00', '2015-12-01');
...
(80, 0, 3, 1333, 1, '2016-01-13', NULL),
(83, 0, 3, 2000, 1, '2016-01-13', NULL),
(84, 1, 3, 20, 1, '2016-01-13', '2,3'),
(85, 2, 3, 100, 1, '2016-01-13', '2,3');
...
(3, 'BG1356001', 'Badge PVC format ISO 13,56MHz - ISO14443A - 1Ko', 1, 1, 5),
