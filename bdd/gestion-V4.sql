...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 04 Janvier 2016 à 17:19
...
INSERT INTO `appro_autre` (`id`, `id_commande`, `id_lecteur`, `quantite`) VALUES
(1, 6, 4, 20),
(2, 6, 3, 10),
(3, 7, 3, 5),
(4, 6, 4, 50);
...
(1, 'Test 1', '', '0608', 735, 1000, 1, 1),
(2, 'Test 2', '', '0608', 30, 10, 1, 2),
(3, 'Test 3', '', '1012', 50, 5000, 2, 3),
(4, 'Test 4', '', '0406', 200, 100, 1, 1),
(5, 'Test 5', '', '0608', 1394, 2000, 1, 1);
...
(50, 1, 4, 100, 1, '2015-12-23', '1,3,5'),
(69, 0, 3, 10, 1, '2015-12-24', NULL),
(70, 0, 4, 95, 1, '2015-12-24', NULL),
(71, 0, 4, 5, 1, '2015-12-24', NULL),
