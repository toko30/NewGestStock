...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 08 Mars 2016 à 09:26
...
(1, 'Test 1', '', '0608', 2000, 1000, 1, 1),
(2, '10.2 kohm, 63 mW, ± 1%, 50 V', '', '0608', 8000, 10, 1, 2),
(3, 'Test 3', '', '1012', 6000, 5000, 2, 3),
(4, 'Test 4', '', '0406', 0, 100, 1, 1),
(5, 'Test 5', '', '0608', 3000, 2000, 1, 1),
(8, 'test 6', NULL, '1214', 100, 200, 3, NULL),
(9, 'test 7', NULL, '1012', 2005, 100, 4, NULL),
(10, 'test 0', NULL, '', 0, 10000, 1, 1);
...
(106, 0, 8, 2000, 1, '2016-03-07', NULL),
(107, 1, 8, 2000, 1, '2016-03-07', '2,5'),
(108, 1, 4, 2000, 1, '2016-03-07', '1,3'),
(109, 2, 8, 2000, 1, '2016-03-07', '2,5'),
(110, 1, 8, 100, 1, '2016-03-07', '2,5');
...
INSERT INTO `type_badge` (`id`, `reference`, `designation`, `quantite`, `frequence`, `type`, `id_fournisseur`) VALUES
(1, 'BG125001', 'Badge PVC blanc Chip 125 KHz EMxx', 0, 2, 1, 5),
(2, 'BG125002', 'Badge PVC Format ISO Chip 125 KHz ATA55xx encodable', 0, 2, 1, 5),
(3, 'BG1356001', 'Badge PVC format ISO 13,56MHz - ISO14443A - 1Ko', 0, 1, 1, 5),
(4, 'BG1356003', 'Badge format ISO Mifare Ultralight - 13.56 MHz - ISO14443A', 0, 1, 1, 5),
(5, 'BG1356MDFG', 'TEST', 0, 1, 2, 5);
...
(1, '3300AT-2', 'Module OEM 13,56MHz  Antenne Intégrée - ISO14443A - ISO15693', 1, 1, 6, 0, 0, 0),
