    ...
    if(appui == 13)
    {
        ...
        if(finEnregistrement == false)
        {
            if(valeurNumSerie.length != 0)
            {
                ...
                {         
                    alert('Le produit est déjà renseigné');  
                }            
            }
            else
            {
        ...
        {
            alert('Tout les produits on été enregistrés'); 
        }
        ...
        {
            $('#titreChange').text('Enregistrement des produits terminé');     
...
$('#addLecteur').on('click', function() 
{
    ...
    else
    {
        ...
        for(i = 0; i < arrayAutre.length; i++)
        {        
            for(var i1 = 0; i1 < arrayRef.length; i1++)
            {
                if(arrayAutre[i].attr('name') == arrayRef[i1])
                {               
                    if(arrayAutre[i].attr('petite') != 0)
                    {
                        for(var i2 = 0; i2 < arrayAutre[i].attr('petite'); i2++)
                        {
                    ...
                    if(arrayAutre[i].attr('moyenne') != 0)
                    {
                        for(var i2 = 0; i2 < arrayAutre[i].attr('moyenne'); i2++)
                        {
                    ...
                    if(arrayAutre[i].attr('grande') != 0)
                    {
                        for(var i2 = 0; i2 < arrayAutre[i].attr('grande'); i2++)
                        {
