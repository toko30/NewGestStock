...
class FicheDescriptive
{
     ...
     * @return FicheDescriptive
     */
    public function addFicheDescriptiveOption(\IC\AdministrationBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption)
    {
     ...
     * @param \IC\AdministrationBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption
     */
    public function removeFicheDescriptiveOption(\IC\AdministrationBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption)
    {
