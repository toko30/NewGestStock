...
class FicheDescriptive
{
     ...
     * @return FicheDescriptive
     */
    public function addFicheDescriptiveOption(\IC\TestBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption)
    {
     ...
     * @param \IC\TestBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption
     */
    public function removeFicheDescriptiveOption(\IC\TestBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption)
    {
