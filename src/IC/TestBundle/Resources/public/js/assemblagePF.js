        ...
        else
        {
            ...
            for(i = 0; i < arrayNumSeriePetite.length; i++)
            {
                if(i%2 == 0)
                {
                    ...
                    if(i + 1 == arrayNumSeriePetite.length)
                    {
            ...
            if(arrayNumSerieMoyenne.length != 0)
                alert('Vérifier que les etiquettes moyennes sont bien dans l\'imprimante');
            
            for(i = 0; i < arrayNumSerieMoyenne.length; i++)
            {
            ...
            if(arrayNumSerieGrande.length != 0)
                alert('Vérifier que les grandes etiquettes sont bien dans l\'imprimante');
            
            for(i = 0; i < arrayNumSerieGrande.length; i++)
            {
