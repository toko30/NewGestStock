...
class FicheDescriptive
{
     ...
     * @return FicheDescriptive
     */
    public function addFicheDescriptiveOption(\IC\ProduitFiniBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption)
    {
     ...
     * @param \IC\ProduitFiniBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption
     */
    public function removeFicheDescriptiveOption(\IC\ProduitFiniBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption)
    {
