...
class NomenclatureLecteur
{
    ...
    /**
     * @var \IC\ProduitFiniBundle\Entity\Firmware
     */
    private $firmware;
     ...
     * Set firmware
     *
     * @param \IC\ProduitFiniBundle\Entity\Firmware $firmware
     *
     * @return NomenclatureLecteur
     */
    public function setFirmware(\IC\ProduitFiniBundle\Entity\Firmware $firmware = null)
    {
     ...
     * Get firmware
     *
     * @return \IC\ProduitFiniBundle\Entity\Firmware
     */
