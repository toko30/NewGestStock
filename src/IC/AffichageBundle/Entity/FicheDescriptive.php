...
class FicheDescriptive
{
     ...
     * @return FicheDescriptive
     */
    public function addFicheDescriptiveOption(\IC\AffichageBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption)
    {
     ...
     * @param \IC\AffichageBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption
     */
    public function removeFicheDescriptiveOption(\IC\AffichageBundle\Entity\FicheDescriptiveOption $ficheDescriptiveOption)
    {
