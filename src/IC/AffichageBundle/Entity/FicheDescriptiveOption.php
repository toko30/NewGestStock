...
class FicheDescriptiveOption
{
    ...
    /**
     * @var \IC\AffichageBundle\Entity\FicheDescriptive
     */
     ...
     * @return FicheDescriptiveOption
     */
    public function addVersionFicheDescriptive(\IC\AffichageBundle\Entity\VersionFicheDescriptive $versionFicheDescriptive)
    {
     ...
     * @param \IC\AffichageBundle\Entity\VersionFicheDescriptive $versionFicheDescriptive
     */
    public function removeVersionFicheDescriptive(\IC\AffichageBundle\Entity\VersionFicheDescriptive $versionFicheDescriptive)
    {
     ...
     *
     * @param \IC\AffichageBundle\Entity\OptionFicheDescriptive $optionFicheDescriptive
     *
     * @return FicheDescriptiveOption
     */
    public function addOptionFicheDescriptive(\IC\AffichageBundle\Entity\OptionFicheDescriptive $optionFicheDescriptive)
    {
     ...
     * @param \IC\AffichageBundle\Entity\OptionFicheDescriptive $optionFicheDescriptive
     */
    public function removeOptionFicheDescriptive(\IC\AffichageBundle\Entity\OptionFicheDescriptive $optionFicheDescriptive)
    {
     ...
     *
     * @param \IC\AffichageBundle\Entity\FicheDescriptive $ficheDescriptive
     *
     * @return FicheDescriptiveOption
     */
    public function setFicheDescriptive(\IC\AffichageBundle\Entity\FicheDescriptive $ficheDescriptive = null)
    {
     ...
     *
     * @return \IC\AffichageBundle\Entity\FicheDescriptive
     */
